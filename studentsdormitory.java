//students dormitory source code and sql coonection with java
import javax.swing.*;
...
JTextField tif1,tif2,tif3,tif4,tif5,tif6;  
    ...
    JButton BU101;
     ...
     JLabel jl,jl1,jl2,jl3,jl4,jl5,jl6;
       ...
       //fee
       JLabel label1,label2,label3,label4,label5,label11,label12,label13,label14,label15;
       JTextField field1,field2,field3,field4,field5, field11,field12,field13,field14,field15;
       JButton button1,button2,button3;
       JLabel label111,label222,label333,label444,label555;//,label11,label12,label13,label14,label15;
       JTextField field111,field222,field333,fieldy444,field555;// field11,field12,field13,field14,field15;
...
//p.getContentPane().add(tf4);p.getContentPane().add(tf5);
p5.getContentPane().add(button1);p5.getContentPane().add(label2);p5.getContentPane().add(label3);
p5.getContentPane().add(label4);
//p.getContentPane().add(l5);p.getContentPane().add(l6);
...
field11 = new JTextField();  
     ...
     label12.setBounds(80, 70, 200, 30);  
     label13.setBounds(80, 110, 200, 30);  
     label14.setBounds(80, 150, 200, 30);  
       
     field11.setBounds(300, 70, 200, 30);  
     field12.setBounds(300, 110, 200, 30);  
     field13.setBounds(300, 150, 200, 30);  
     //tf4.setBounds(300, 190, 200, 30);  
     //tf5.setBounds(300, 230, 200, 30);
     button2.setBounds(170, 350, 150, 30);
q5.getContentPane().add(field11);q5.getContentPane().add(field12);q5.getContentPane().add(field13);
//p.getContentPane().add(tf4);p.getContentPane().add(tf5);
q5.getContentPane().add(button2);q5.getContentPane().add(label12);q5.getContentPane().add(label13);q5.getContentPane().add(label14);
//p.getContentPane().add(l5);p.getContentPane().add(l6);
q5.getContentPane().add(label1);
button2.addActionListener(this);

//delete fee
button3=new JButton("DELETE_FEE");
button3.setFont(new Font("Tahoma", Font.PLAIN, 14));
button3.setBackground(Color.WHITE);
label111=new JLabel("    FEE DELETION");
label111.setFont(new Font("Tahoma", Font.PLAIN, 18));
label111.setVerticalAlignment(SwingConstants.TOP);
label111.setBounds(100, 30, 400, 30);
label222 = new JLabel("Month:");  
label222.setFont(new Font("Tahoma", Font.PLAIN, 14));
   label333 = new JLabel("IS FEE paid:");  
   label333.setFont(new Font("Tahoma", Font.PLAIN, 14));
   label444 = new JLabel("STU_ID:");  
   label444.setFont(new Font("Tahoma", Font.PLAIN, 14));
  
field111 = new JTextField();  
   field222 = new JTextField();  
   field333 = new JTextField();  
 
   label222.setBounds(80, 70, 200, 30);  
   label333.setBounds(80, 110, 200, 30);  
   label444.setBounds(80, 150, 200, 30);  
     
   field111.setBounds(300, 70, 200, 30);  
   field222.setBounds(300, 110, 200, 30);  
   field333.setBounds(300, 150, 200, 30);  
   //tf4.setBounds(300, 190, 200, 30);  
   //tf5.setBounds(300, 230, 200, 30);
   button3.setBounds(170, 350, 150, 30);
   r5.getContentPane().add(field111);r5.getContentPane().add(field222);r5.getContentPane().add(field333);
//p.getContentPane().add(tf4);p.getContentPane().add(tf5);
r5.getContentPane().add(button3);r5.getContentPane().add(label222);r5.getContentPane().add(label333);r5.getContentPane().add(label444);
//p.getContentPane().add(l5);p.getContentPane().add(l6);
r5.getContentPane().add(label111);
...
public void actionPerformed(ActionEvent arg0) {
        ...
        {  
           int x=0;  
           String s1 = field11.getText();  
           String s2 = field12.getText();  
           String s3 = field13.getText();
          // String s4 = tff4.getText();  
           //String s5 = tff5.getText();  
           //String s6 = tff6.getText();  
           if (true)
           {  
               ...
               {  
                   ...
                   Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","sushma","vasavi");
   //String query="update admin set admin_name=? ,admin_mob=? "+"where admin_id=?";
    PreparedStatement ps = con.prepareStatement("update fee set feem=? ,sfee=? where stu_id=?");  
                  ps.setString(1, s1);  
                   ps.setString(2, s2);  
                   ps.setString(3, s3);  
                   //ps.setString(4, s5);  
                   ...
                   if (x > 0)  
                   {  
                       JOptionPane.showMessageDialog(button2, "Data Updated Successfully");  
                   }  
               }  
               catch (Exception exw)  
               {  
           ...
           {  
               JOptionPane.showMessageDialog(button2, "not possible");  
           }  
         }  
        ...
        {  
           ...
           {  
               ...
               {  
                   Class.forName("oracle.jdbc.driver.OracleDriver");  
                   Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","sushma","vasavi");
String query="delete from fee where stu_id=?";
    PreparedStatement ps = con.prepareStatement(query);
                   ps.setString(1, s1);  
                   //ResultSet rs =
                   ps.executeUpdate();  
                   ...
                   if (x > 0)  
                   {  
                       JOptionPane.showMessageDialog(button3, "Data Deleted Successfully");  
                   }  
//conn.close();
               }  
               catch (Exception exh)  
           ...
           {  
               JOptionPane.showMessageDialog(button3, "not possible");  
           }  
         }  
